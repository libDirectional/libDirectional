classdef AbstractHypersphereSubsetGridDistributionTest < matlab.unittest.TestCase    
    methods(Test)
        % Test conversions
        function testMeanAxis(testCase)
            ...
            wdFull = HypersphericalGridDistribution.fromDistribution(bd,100001);
            wdHemi = HyperhemisphericalGridDistribution.fromDistribution(bdHemi,100001);
