classdef AbstractSphericalHarmonicDistributionTest< matlab.unittest.TestCase    
    methods (Test)
        function testConvolutionDimAndMeanAndNormalization(testCase)
            ...
            rshdRandom=SphericalHarmonicDistributionReal(coeffMat);
            ...
            cshdZonal=SphericalHarmonicDistributionComplex(coeffMatZonal);
            
            % Test both for real and complex
            shdRandoms={rshdRandom,rshdRandom.toSphericalHarmonicDistributionComplex};
            shdZonals={cshdZonal.toSphericalHarmonicDistributionReal,cshdZonal};
            for i=1:2
        ...
        function testConvolution(testCase)
            ...
            shdBeforePredict=SphericalHarmonicDistributionComplex.fromDistributionFast(fBeforePredict,order);
            ...
            shdTrans=SphericalHarmonicDistributionComplex.fromDistributionFast(VMFDistribution([0;0;1],kappaTran),order);
