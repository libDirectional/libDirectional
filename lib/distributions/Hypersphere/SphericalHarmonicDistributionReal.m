classdef SphericalHarmonicDistributionReal < AbstractSphericalHarmonicDistribution
    methods
        function this=SphericalHarmonicDistributionReal(coeffMat,transformation)
        ...
        function shd=toSphericalHarmonicDistributionComplex(this)
        ...
        function shd=rotate(this,alpha,beta,gamma)
            ...
            shdComplex=this.toSphericalHarmonicDistributionComplex;
            shdComplexRot=shdComplex.rotate(alpha,beta,gamma);
            shd=shdComplexRot.toSphericalHarmonicDistributionReal;
        end
